        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_contrato_lancado",
                    models.BooleanField(
                        default=False, help_text="Contrato foi lançado corretamente"
                    ),
                ),
                (
                    "is_horas_lancadas",
                    models.BooleanField(
                        default=False, help_text="Horas foram lançadas corretamente"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Meta de resolução foi atingida"
                    ),
                ),
                (
                    "is_atualizaca_logs_correto",
                    models.BooleanField(
                        default=False, help_text="Logs foram atualizados corretamente"
                    ),
                ),
                (
                    "is_ticket_encerrado_corretamente",
                    models.BooleanField(
                        default=False, help_text="Ticket foi encerrado corretamente"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Cliente foi notificado adequadamente"
                    ),
                ),
                (
                    "is_category_correto",
                    models.BooleanField(
                        default=False, help_text="Categorização está correta"
                    ),
                ),
                (
                    "incident",
